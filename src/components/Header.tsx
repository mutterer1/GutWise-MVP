...
export default function Header() {
  return (
    <header className="motion-reveal-soft fixed inset-x-0 top-0 z-30 border-b border-[rgba(202,190,255,0.12)] bg-[rgba(7,10,24,0.78)] backdrop-blur-xl">
      <nav
      ...
      >
        <Link to="/" className="motion-nav-link flex items-center rounded-2xl" aria-label="GutWise home">
          <img
            ...
            alt="GutWise"
            className="block h-[46px] w-auto sm:h-[58px]"
          />
        </Link>
